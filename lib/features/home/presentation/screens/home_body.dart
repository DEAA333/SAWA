      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // ✅ القائمة الموحدة (مهام + مشتريات) — تتحدث تلقائياً لما يُضاف عنصر جديد
            Obx(() {
              // استخدام .value يضمن أن الـ Obx يتحرك لما تتغير القوائم
              final tasks = Get.find<ActivitiesController>().tasksList.value;
              final purchases = Get.find<ActivitiesController>().purchasesList.value;
              final allItems = [...tasks, ...purchases];
        ...
        children: [
          Column(
            ...
            children: [
              Obx(
                    () => Text(
                  '${controller.completedTasks.value}/${controller.totalTasks.value} تم إنجازهم',
                  style: AppTextStyles.splashSubtitle.copyWith(
                    fontSize: 12,
            ...
            Expanded(
              child: Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    // ✅ نقرأ من ActivitiesController مباشرة عشان يتحدث تلقائياً
                    Obx(
                          () => Text(
                        '${Get.find<ActivitiesController>().tasksList.value.where((t) => t.status == 'pending').length}',
                        style: AppTextStyles.splashSubtitle.copyWith(
                          fontSize: 24,
                          fontWeight: FontWeight.bold,
                          color: Colors.black,
